    ...
    <div className="min-h-screen bg-[#0974f1] flex flex-col items-center px-4 pt-6 pb-0 md:px-8 md:pt-8 lg:px-12 lg:pt-12 font-sans text-slate-900 relative overflow-x-hidden w-full">
      ...
      <div className="absolute top-4 right-4 md:top-6 md:right-6 flex items-center gap-2 z-50">
        <button
          ...
          className="flex items-center gap-1.5 bg-white px-3 py-1.5 rounded-full shadow-md border border-slate-100 transition-transform hover:scale-105 active:scale-95 cursor-pointer"
        >
          <Languages className="w-4 h-4 text-[#0974f1]" />
          <span className="text-xs font-bold text-slate-700 w-5">{lang === 'en' ? '中' : 'EN'}</span>
        </button>

        <div className="relative flex items-center gap-1.5 bg-white px-2.5 py-1.5 rounded-full shadow-md border border-slate-100 transition-transform hover:scale-105 flex-1 min-w-0 max-w-[160px] sm:max-w-none">
